...
const BOXES_DATA = [
    ...
    },
    {
        name: 'Paris Bercy',
        meter: 10,
        description: 'Located near Paris Bercy, this 10 m² unit provides a secure, clean, and convenient storage space for all your needs. Ideal for professionals and individuals alike, with easy access and optimal protection for your belongings.',
        price: 120,
        images: ['/assets/box/boxes.webp'],
        address: '15, rue de Bercy 75012 Paris',
        city: 'Paris'
    },
    {
        name: 'Marseille Prado',
        meter: 6,
    ...
    },
    {
        name: 'Bordeaux Lac',
        meter: 9,
        description: 'Situated in Bordeaux Lac, this 9 m² storage unit combines practicality and security, ideal for furniture, sports gear, or business materials.',
        price: 90,
        images: ['/assets/box/boxes.webp'],
        address: '11, avenue des Quatre Pavillons 33300 Bordeaux',
        city: 'Bordeaux'
    },
    {
        name: 'Marseille Saint-Isidore',
        meter: 7,
